...
//    public static final String NODEID_LAST_PLLR = "8387";
     ...
     * 固定资产采购申请流程-发起节点nodeid
     */
    public static final String NODEID_FIRST_GDZCSQ = bs.getPropValue("jf", "NODEID_FIRST_GDZCSQ");

    /**
     * 固定资产采购申请流程-归档前节点(目前为了测试写第一个节点)
     */
    public static final String NODEID_LAST_GDZCSQ = bs.getPropValue("jf", "NODEID_LAST_GDZCSQ");

    /**
     * 固定资产批量录入流程-发起节点nodeid
     */
    public static final String NODEID_FIRST_PLLR = bs.getPropValue("jf", "NODEID_FIRST_PLLR");

    /**
     * 固定资产批量录入流程-归档前节点(目前为了测试写第一个节点)
     */
    public static final String NODEID_LAST_PLLR = bs.getPropValue("jf", "NODEID_LAST_PLLR");
